# Math Magician App
The Math Magician App is a calculator app built with React. In this milestone, I have used react components. However, I added the logic needed to make the Calculator component to work.
